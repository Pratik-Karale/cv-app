...
export default class ProfileImage extends Component {
    ...
    showImage(file,elem){
      ...
      fileReader.onload=(e)=>{
        ...
        this.url=e.target.result.replace(/(\r\n|\n|\r)/gm, "")
        elem.style.background=`url("${this.url}")`
      }
